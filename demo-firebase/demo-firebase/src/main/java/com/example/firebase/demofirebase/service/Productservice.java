package com.example.firebase.demofirebase.service;
...
public class Productservice {
    ...
    public Product getProductDetailyname(String name) throws ExecutionException, InterruptedException {
        Firestore dbFirestore = FirestoreClient.getFirestore();
    ...
    public String deleteProduct(String name) throws ExecutionException, InterruptedException {
        ...
        return "Document with product if  "+name+"  has been deleted successfully";
